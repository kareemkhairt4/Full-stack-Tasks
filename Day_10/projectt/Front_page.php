...
<div class="container mt-5">
    <div class="row mb-4">
        ...
        <div class="col-md-2 text-end  ">
            <a class="btn btn-outline-dark text-white w-100 bg-dark" href="<?= $Const_URL ?>/login.php">Go To Admin Panel</a>
        </div>
        <div class="col-md-2 text-end">
            <a class="btn btn-outline-secondary text-secondary w-100" href="<?= $Const_URL ?>/login.php">View Login Logs</a>
        </div>
        <div class="col-md-3 text-end">
            <a class="btn btn-outline-danger text-danger w-100" href="<?= $Const_URL ?>/login.php">View Failed Login Attends</a>
        </div>
        <?php } ?>
        <?php if ($Role == "user") { ?>
             <div class="col-md-2 text-end">
            <a class="btn btn-outline-secondary text-white w-100 bg-secondary" href="<?= $Const_URL ?>/login.php">User Dashboard</a>
        </div>
        <?php } ?>
    </div>
